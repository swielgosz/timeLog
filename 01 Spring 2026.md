...
- Is there a significant difference between if do train/test split or test/train split? This may not be relevant because we have v; ,/mk,.
- ''
### Seeding study
...
So, we need to take a group of runs each with a different seed. In general, we have been training models on training sets and then 
