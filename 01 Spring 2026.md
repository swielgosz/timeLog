...
The best from the top right subplot is segment length = 4, output = logmag_unit_exp. This is run id 

It seems like there is a balance of length strategy and segmentation legnth to strike. If a segment is of length 4 and then we use the length strat, that is essentially useless I think (but let's poke further into this later). 