...
without enforcing _what_ that geometry should be.

---

### **5️⃣ Distributional trajectory loss (agnostic, but expensive)**

  

Treat trajectories as distributions in phase space and compare via:

- sliced Wasserstein distance
    
- MMD
    
- energy distance (statistical, not physical)
...
- very assumption-free
    
- very heavy
    
- more useful for generative models than prediction
