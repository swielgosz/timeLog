...
Let's check if our model is stiff. We will first try using diffrax.ImplicitEuler as our solver and compare it to the results of diffrax.Tsit45. Run id 97oabg96. We will also 
