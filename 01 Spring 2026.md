...
Things we can check:
- tighten tolerances - if steps jump from ~2 to ~20-50, then the solver is being lenient and is just integrating coarsely. If it stays low, the dynamics are very smooth and may
