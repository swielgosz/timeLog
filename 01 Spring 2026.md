...
- [x] Fix normalization of SMA in the heatmap
	- [x] update to plot earth, and create two figs where one is a simple test orbit and one is complex
- [x] clean up the visualize_mean_acc_error script
- [x] Vector field visualization of some sort
- [x] batch size experiment
- [x] n orbits vs segmentation length
- [x] Rerun visualize_mean_acc_error.py with new training on different feature and output layers
- [x] boxplot 
	- [x] can we include batch size here?
