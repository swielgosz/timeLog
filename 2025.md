...
- Went down a rabbit hole refreshing on coordinate frames, conversions, etc. My progression of thoughts:
	...
	- I think this makes sense. I am comfortable ignoring spherical velocities for now (until we have a reason not to in case there is something I'm not considering right now). But I'm going to come back to this after I do some other work and calculate velocities using method outlined in top comment: https://physics.stackexchange.com/questions/546479/conversion-of-cartesian-position-and-velocity-to-spherical-velocity
