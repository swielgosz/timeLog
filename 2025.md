...
- Researching how to implement multiple orbits/initial attempts
	- Looks like I will need latent variables to represent the orbit's parameters - the neural ODE will not generalize well to new orbital conditions if I just train directly on multiple orbits

# 03/06
- [ ] Read Salmander (Murphy) - this is similar to what I am doing and talk a 
- Implement latent variables so I can train on multiple orbits - this might correspond 
