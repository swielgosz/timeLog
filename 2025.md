...
- Improved multiple data generation code so that orbital elements were stepped through in a defined manner, rather than creating orbits using random orbital elements within a defined range. I used this dataset for testing and results are garbage. Through debugging, I noticed that features are not well scaled. 
