...
- [ ] Draft of introduction - doesn't have to be good! Hard limit - 2 hrs
- [ ] After intro draft is completed, determine:
	- [ ] what my plot(s) for next week should be
	- [ ] next coding priority
- [ ] Put together intro slides for X-Lab group meting:
	- [ ] First conference paper and journal paper timeline
