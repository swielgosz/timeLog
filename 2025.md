...
- [ ] Finalize lit review presentation and write down talking points
- [x] Get visualization working
- [ ] verify that spherical coordinates are working (I previously coded them in but didn't have a chance to check if it was correct)

Accomplishments:
- visualization working
	- update - earlier I (think I) had it working where if I ran code in devcontainer in vscode, plot would appear locally. Now, when I run code from devcontainer,  plots do not appear. 