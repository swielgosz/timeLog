...
Intentions for the week to be successful!:
 - I keep setting goals ambitiously and then operate slower than necessary to achieve all of them (and/or more fires come up to put out than I would like). No problem - this week I will try setting fewer "must do" goals and a couple stretch goals each day just for a more positive re
### 2/24
Realistic goals:
