# October 21
implement save best model - this amounts to saving the weights resulting in the lowest current training loss
loss is lowest with the right configuration of data - we expect certain 
curriculum training is a must! - increase segmentation strategy, changing batch, feature layers, output layers

ping aarun for 
zar
zaratan jobs will be lightweight without gpu -  we can do this or not
visualization work left to be done
