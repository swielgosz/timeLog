...
| label                                                 | Loss                                                | complex_TBP_planar_1_test | complex_TBP_planar_10_test | complex_TBP_planar_100_test |
| :---------------------------------------------------- | :-------------------------------------------------- | ------------------------: | -------------------------: | --------------------------: |
| HiFi (conference config - signed acceleration output) | Percent error                                       |                      3.87 |                       3.57 |                        3.45 |
| HIFI (abs value acceleration output)                  | Percent error                                       |                      2.86 |                       3.08 |                        2.86 |
| LoFi                                                  | Percent error                                       |                      2.62 |                       3.28 |                        2.73 |
| LoFi                                                  | Percent error +  RMSE (normalized to similar scale) |                      2.76 |                       2.72 |                        2.34 |
