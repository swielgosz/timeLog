...
`model` is an instance of the `NeuralODE` class (an instance of a class is just an object). `model.func` is an instance of `Func` which wrapes the MLP plus feature/output layers and constraints. The `__call__` method of Func
# December 12
