...
## Training
### "simple-1-hifi-outputincorrect"
run_id: fxazk1iq
runtime:
config:
``` python
wandb:
  group: "simple-1-hifi-outputincorrect"  # Change this to your desired group name

data:
  dataset_name : "simple_TBP_planar_1"
  problem: '2BP'
...
parameters:
  ...
  atol: 0.00000001
```
## "simple-1-hifi-output-correct"
run_id: wyl16e2k
runtime: 17:35
config:
``` python
wandb:
  group: "simple-1-hifi-outputcorrect"  # Change this to your desired group name
...
parameters:
  ...
  atol: 0.00000001
```
## "complex-1-hifi-incorrect"
## "complex-1-hifi-correct"

## "simple-10-hifi-incorrect"
## "simple-10-hifi-correct"

I want to run three tests on the
Do we need to use the same dataset that we were using for the conference? 
It shouldn't matter, as long as we are consisten with our training and testing data
