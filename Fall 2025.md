...
Let's try changing how we actually represent the acceleration. 
We also haven't tried the raw representation in aa while since changing other arts of the pipeline. 
## output layer: RSW representation
# December 3
Recap:
