...
| label                                | Acceleration output - signed (bad) or abs val (good) | Total steps | Runtime (min:sec) | Loss                                                | complex_TBP_planar_1_test | complex_TBP_planar_10_test | complex_TBP_planar_100_test |
| :----------------------------------- | :--------------------------------------------------- | :---------- | :---------------- | :-------------------------------------------------- | ------------------------: | -------------------------: | --------------------------: |
