...
randomly selected reference orbit (I don't love that it's nearly circular):
![[Pasted image 20251107102459.png]]
![[Pasted image 20251107102312.png]]

## v2 - segmentation strategy, no length strat, combined loss, mse_weight = 10
``` python
data:
  dataset_name : "complex_TBP_planar_16"
  problem: '2BP'
